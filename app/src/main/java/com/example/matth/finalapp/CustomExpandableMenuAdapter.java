...
public class CustomExpandableMenuAdapter extends BaseExpandableListAdapter {

    private Context context;
    private List<String> expandableListTitle;
    private HashMap<String, List<String>> expandableListDetail;

    public CustomExpandableMenuAdapter(Context context, List<String> expandableListTitle,
